    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.update", [$customer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="hidden" value="<?php echo $customer->status;?>" id="update_status_val" name="status">  
             <div class="form-group">
                <label class="required">{{ trans('cruds.customer.fields.status') }}</label>
                <div class="custom-control custom-switch custom-switch-success">
                <input type="checkbox" class="custom-control-input approved_status_update" <?php echo ($customer->status==1 ? 'checked' : null)?>  id="customSwitch2_<?php echo $customer->id;?>" />
                <label class="custom-control-label" for="customSwitch2_<?php echo $customer->id;?>">
