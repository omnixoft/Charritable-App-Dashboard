...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.customers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="profile">{{ trans('cruds.customer.fields.profile') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.customer.fields.profile_helper') }}</span>
            </div>
...
<script>
    ...
    init: function () {
@if(isset($customer) && $customer->profile)
      var file = {!! json_encode($customer->profile) !!}
