    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.contactuses.update", [$contactUs->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $contactUs->title_ar) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hot_line') ? 'is-invalid' : '' }}" type="text" name="hot_line" id="hot_line" value="{{ old('hot_line', $contactUs->hot_line) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('reception_line') ? 'is-invalid' : '' }}" type="text" name="reception_line" id="reception_line" value="{{ old('reception_line', $contactUs->reception_line) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('auditor_service_manager') ? 'is-invalid' : '' }}" type="text" name="auditor_service_manager" id="auditor_service_manager" value="{{ old('auditor_service_manager', $contactUs->auditor_service_manager) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('fax') ? 'is-invalid' : '' }}" type="text" name="fax" id="fax" value="{{ old('fax', $contactUs->fax) }}">
                @if($errors->has('fax'))
                    <div class="invalid-feedback">
                        {{ $errors->first('fax') }}
                    </div>
