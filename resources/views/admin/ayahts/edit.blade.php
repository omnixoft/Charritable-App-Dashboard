...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.ayaht.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.ayahts.update", [$ayaht->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="title">{{ trans('cruds.ayaht.fields.title') }}</label>
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $ayaht->title) }}">
                @if($errors->has('title'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title_ar') ? 'is-invalid' : '' }}" type="text" name="title_ar" id="title_ar" value="{{ old('title_ar', $ayaht->title_ar) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('ayaht') ? 'is-invalid' : '' }}" name="ayaht" id="ayaht">{{ old('ayaht', $ayaht->ayaht) }}</textarea>
                @if($errors->has('ayaht'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ayaht') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('translation') ? 'is-invalid' : '' }}" name="translation" id="translation">{{ old('translation', $ayaht->translation) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refrence') ? 'is-invalid' : '' }}" type="text" name="refrence" id="refrence" value="{{ old('refrence', $ayaht->refrence) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('refrence_ar') ? 'is-invalid' : '' }}" type="text" name="refrence_ar" id="refrence_ar" value="{{ old('refrence_ar', $ayaht->refrence_ar) }}">
