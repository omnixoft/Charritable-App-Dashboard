...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.donationtype.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.donationtypes.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('type_ar') ? 'is-invalid' : '' }}" type="text" name="type_ar" id="type_ar" value="{{ old('type_ar', '') }}" required>
