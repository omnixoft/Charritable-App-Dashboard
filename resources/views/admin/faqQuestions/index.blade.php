                        ...
                        <tr data-entry-id="{{ $faqQuestion->id }}">
                            ...
                            <td>
                                ...
                                <div class="dropdown">
                                 ...
                                 <a class="dropdown-item" href="{{ route('admin.faq-questions.show', $faqQuestion->id) }}">
                                    <i class="fa fa-eye"></i> <span class="ml-1">{{ trans('global.view') }}</span>
                                 </a>
                             @endcan
                             @can('faq_question_edit')
                                 <a class="dropdown-item" href="{{ route('admin.faq-questions.edit', $faqQuestion->id) }}">
                                   <i class="fa fa-pen"></i>  <span class="ml-1">{{ trans('global.edit') }}</span>
                                 </a>
                             @endcan
                             @can('faq_question_delete')
                                     <form action="{{ route('admin.faq-questions.destroy', $faqQuestion->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: block;">
