                        ...
                        <tr data-entry-id="{{ $taskStatus->id }}">
                            ...
                            <td>
                                ...
                                @can('task_status_show')
                                    <a class="dropdown-item" href="{{ route('admin.task-statuses.show', $taskStatus->id) }}">
                                        <i class="fa fa-eye"></i> 
                                        <span class="ml-1">
                                        {{ trans('global.view') }}
                                        </span>
                                ...
                                @can('task_status_edit')
                                    <a class="dropdown-item" href="{{ route('admin.task-statuses.edit', $taskStatus->id) }}">
                                        <i class="fa fa-pen"></i>  
                                        <span class="ml-1">
                                        {{ trans('global.edit') }}
                                        </span>
                                ...
                                @can('task_status_delete')
                                    <form action="{{ route('admin.task-statuses.destroy', $taskStatus->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: block;">
