                        ...
                        <tr data-entry-id="{{ $faqCategory->id }}">
                            ...
                            <td>
                                ...
                                @can('faq_category_show')
                                    <a class="dropdown-item" href="{{ route('admin.faq-categories.show', $faqCategory->id) }}">
                                        <i class="fa fa-eye"></i> 
                                        <span class="ml-1">
                                        {{ trans('global.view') }}
                                        </span>
                                ...
                                @can('faq_category_edit')
                                    <a class="dropdown-item" href="{{ route('admin.faq-categories.edit', $faqCategory->id) }}">
                                        <i class="fa fa-pen"></i>  
                                        <span class="ml-1">
                                        {{ trans('global.edit') }}
                                        </span>
                                ...
                                @can('faq_category_delete')
                                    <form action="{{ route('admin.faq-categories.destroy', $faqCategory->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: block;">
