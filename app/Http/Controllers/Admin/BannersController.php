        ...
        if ($request->ajax()) {
            ...
            $table->editColumn('image', function ($row) {
                ...
                return '<div class="avatar-wrapper">
                    ...
                    <a href="'.$row->image->url.'" target="_blank" style="display: inline-block">
                    <img src="'.$row->image->thumbnail.'" width="50px" height="50px" alt="img">
                    </a>
                    </div></div>';
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'title','image','status']);
